...
- (instancetype)initWithRequest:(NSURLRequest *)request session:(NSURLSession *)session {
    if (self = [super init]) {
        ...
        NSURLProtectionSpace *protectionSpace = [[NSURLProtectionSpace alloc] initWithHost:self.host port:self.port.integerValue protocol:self.scheme realm:self.host authenticationMethod:NSURLAuthenticationMethodHTTPBasic];
